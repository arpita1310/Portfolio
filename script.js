...
sr.reveal(".experience-section", { delay: 100 });
...
document.getElementById("resume").addEventListener("click", function () {
  var link =
    "https://drive.google.com/file/d/1TADm14FxdxP2A4hHsPVkREuscrFTBO7b/view?usp=sharing";
  window.open(link, "_blank");
});

document.getElementById("check-repo").addEventListener("click", function () {
  var link = "https://github.com/arpita1310";
  window.open(link, "_blank");
});

document.getElementById("leetcode").addEventListener("click", function () {
  var link = "https://leetcode.com/u/arpita1310/";
  window.open(link, "_blank");
});
...
document.getElementById("linkedin-btn").addEventListener("click", function () {
  var link = "https://www.linkedin.com/in/arpita-singh-343528221/";
  window.open(link, "_blank");
});
